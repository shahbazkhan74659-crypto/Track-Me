...
test("formats real earned/advance/net figures and the present/half-day subtext", async ({ mount }) => {
  const summary: SummaryData = {
    perDaySalary: 800,
    presentDays: 3,
    halfDays: 1,
  ...
  await expect(component.getByText("3 present · 1 half-day")).toBeVisible();
