...
- **Not yet built**: no aggregate calculations (Earned So Far / Advance Taken / Net Payable) — that's Phase 7, and this phase's `GET` deliberately returns only raw per-day rows.
